<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="proxytest.aspx.cs" Inherits="OWASP.WebGoat.NET.proxytest" MasterPageFile="~/resources/Master-Pages/Site.Master"%>

<asp:Content ID="Content3" ContentPlaceHolderID="HelpContentPlaceholder" runat="server">
    Set up your web proxy, and test it here.  The field has a validator that only allows alphabetic characters.  See if you can circumvent this protection using your proxy!
</asp:Content>
