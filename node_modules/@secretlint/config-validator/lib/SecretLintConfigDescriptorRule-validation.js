...
exports.SecretLintConfigDescriptorRuleSchema = {
...
exports.isSecretLintConfigDescriptorRule = exports.ajv.compile(exports.SecretLintConfigDescriptorRuleSchema);
function validate(value) {
    if (exports.isSecretLintConfigDescriptorRule(value)) {
        return value;
    }
    else {
        throw new Error(exports.ajv.errorsText(exports.isSecretLintConfigDescriptorRule.errors.filter((e) => e.keyword !== 'if'), { dataVar: 'SecretLintConfigDescriptorRule' }) +
            '\n\n' +
            util_1.inspect(value));
    }
}
exports.default = validate;
//# sourceMappingURL=SecretLintConfigDescriptorRule-validation.js.map