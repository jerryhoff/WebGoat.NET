...
exports.SecretLintConfigDescriptorRulePresetSchema = {
...
exports.isSecretLintConfigDescriptorRulePreset = exports.ajv.compile(exports.SecretLintConfigDescriptorRulePresetSchema);
function validate(value) {
    if (exports.isSecretLintConfigDescriptorRulePreset(value)) {
        return value;
    }
    else {
        throw new Error(exports.ajv.errorsText(exports.isSecretLintConfigDescriptorRulePreset.errors.filter((e) => e.keyword !== 'if'), { dataVar: 'SecretLintConfigDescriptorRulePreset' }) +
            '\n\n' +
            util_1.inspect(value));
    }
}
exports.default = validate;
//# sourceMappingURL=SecretLintConfigDescriptorRulePreset-validation.js.map